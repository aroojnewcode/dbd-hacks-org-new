...
export const pageSitemapMeta: Record<PageId, PageSitemapMeta> = {
	...
	/** Money URL for "dead by daylight cheats" */
	...
	'skill-check': { priority: 0.85, changefreq: 'weekly', i18nPriority: 0.8, lastmod: '2026-09-15' },
	...
	'world-esp': { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-09-15' },
	'eac': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-13' },
	'dbd-esp': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-13' },
	'dbd-aimbot': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-13' },
