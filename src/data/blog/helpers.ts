...
const imageMap: Record<BlogImageKey, string> = {
	...
	cheatsPackage: dbdImages.espWallhack,
	playerEsp: dbdImages.playerEsp,
	rebootFight: dbdImages.aimbotCombat,
	battleRoyaleCombat: dbdImages.cheatsCombat,
	battleRoyaleIslandMap: dbdImages.espWallhack,
};
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /DBD Hacks|Aimbot|ESP|Undetected|Comparisons/i.test(post.category);
		entries.push({
