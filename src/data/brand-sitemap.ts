...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		caption: 'Dead by Daylight hack menu on Windows PC',
	},
	{
		src: '/images/dbd-screenshot-esp-neon.webp',
		title: 'DBD ESP wallhack',
		caption: 'ESP overlay during a Dead by Daylight trial',
	},
	{
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in DBD', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'dbd-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'dbd-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and aimbot controls in {primaryKeyword}' },
	features: { title: '{primaryKeyword} features', caption: 'ESP, aimbot, and radar included with {primaryKeyword}' },
	...
	'world-esp': { title: '{primaryKeyword} World ESP', caption: 'Generator, totem, and hook markers in {primaryKeyword}' },
	eac: { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a EAC update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Dead by Daylight on PC' },
	...
	'skill-check': { title: '{primaryKeyword} aimbot', caption: 'Aimbot settings in {primaryKeyword}' },
