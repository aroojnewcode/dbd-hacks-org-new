...
export const simplePageCopy: Partial<Record<PageId, SimplePageCopy>> = {
	features: page({
		...
		ctaSecondaryHref: brand.checkoutUrl,
		galleryTitle: 'In-game look',
		sections: [
			{
				h2: 'ESP & wallhack',
				paragraphs: [
					'See Survivors, Killers, bosses, and loot through walls with distance readouts.',
					'Use filters so the overlay stays clear in mid-chase, tight maps, and killer-side chaos.',
				],
				list: ['Player boxes & distance', 'Generator, totem, and hatch markers', 'Boss and Killer filters'],
			},
			{
				h2: 'Aimbot & aimbot',
				paragraphs: [
			...
			},
			{
				h2: 'Radar',
				paragraphs: [
					'A simple World ESP for threats outside your view.',
					'Spot approaches near exit gates without filling the whole screen.',
				],
	...
	updates: page({
		...
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'DBD Hacks overview',
		...
		sections: [
			{
				h2: 'Current status',
				paragraphs: [
					'As of 13 Aug 2026 the package is online for Dead by Daylight on Windows PC. We post a new note here when a game or EAC patch needs a rebuild.',
	...
	hacks: page({
		...
		galleryTitle: 'Hack gameplay & menu images',
		sections: [
			{
				h2: 'Features',
				paragraphs: [
					'One undetected license covers ESP wallhack, aimbot, and World ESP for Survivor and Killer sides on Windows PC.',
					'See the full breakdown on the <a href="/features/">Features page</a> — or jump to <a href="/dbd-esp/">ESP</a>, <a href="/dbd-aimbot/">Aimbot</a>, and <a href="/dbd-world-esp/">Radar</a> guides.',
				],
				list: [
					'Player ESP boxes, distance, and objective markers',
					'Configurable aimbot — FOV, smoothness, bone priority',
					'World ESP / radar for approaches and exit gates',
			...
			},
			{
				...
				paragraphs: [
					'You need a valid license from the Store before install. Follow the step-by-step guide on <a href="/setup/">Setup</a>.',
				],
				list: [
					'Windows 10 or 11 (64-bit)',
					'Administrator rights for the loader',
					'License key from your order email',
					'Disable conflicting overlays (other second killer pressure tools)',
					'Check <a href="/updates/">Status</a> after every major {game} or {antiCheat} patch',
				],
			},
			{
				h2: 'Gameplay images',
				paragraphs: [
					'Screenshots below show the in-match menu, ESP overlays, and trial gameplay with DBD Hacks enabled. Every image includes a descriptive alt text for accessibility.',
				],
				list: [
					'Mod menu — Survivor, Killer, ESP, and exploit tabs',
					'Neon ESP — distance tags and pallet markers',
					'Live trial — vault markers and perk readouts',
				],
			},
			{
				h2: 'How to start',
				paragraphs: ['Compare plans on the Store, install via Setup, then confirm Status before you queue.'],
				list: [
					'<a href="/pricing/">Store & plans</a>',
	...
	'dbd-esp': page({
		title: 'DBD ESP | {brand}',
		description:
			'DBD ESP and wallhack for Dead by Daylight on Windows PC — player boxes, distance, object filters, and clear overlays in trials.',
		h1: 'ESP',
		intro: 'See players and loot through walls during DBD trials. Part of the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'DBD Hacks overview',
		ctaSecondaryHref: '/dbd-cheats/',
		...
		sections: [
			{
				h2: 'What ESP shows',
				paragraphs: ['Boxes, distance, and filters for Survivors, Killers, bosses, and loot.'],
				list: ['Player ESP', 'Loot markers', 'Boss and Killer filters'],
			},
			{
				h2: 'When to use it',
				paragraphs: ['Clear mid-chase, indoor tiles, and killer trials without flooding the screen.'],
			...
			},
			{
				...
				list: [
					'<a href="/dbd-cheats/">Full product</a>',
					'<a href="/features/">All features</a>',
					`<a href="${brand.checkoutUrl}" rel="noopener noreferrer">Store</a>`,
				],
			},
		],
	}),
	'dbd-aimbot': page({
		...
		description:
			'DBD aimbot and aimbot for Dead by Daylight on Windows PC — FOV, smoothness, and bone priority you can tune per killer.',
		h1: 'Aimbot',
		intro: 'Aimbot and aim assist you can tune for DBD. Included in the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'DBD Hacks overview',
		ctaSecondaryHref: '/dbd-cheats/',
		...
		sections: [
			...
			},
			{
				...
				list: ['Legit aimbot', 'Per-killer profiles', 'Works with ESP'],
			},
			{
				h2: 'Next steps',
	...
	'world-esp': page({
		title: 'DBD Radar | {brand}',
		description:
			'DBD World ESP for Dead by Daylight on Windows PC — flank cues near exit gates without filling the whole screen.',
		h1: 'Radar',
		intro: 'A simple World ESP for threats outside your view. Included in the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'DBD Hacks overview',
		ctaSecondaryHref: '/dbd-cheats/',
		...
		sections: [
			{
				h2: 'What it shows',
				paragraphs: ['Nearby enemy cues with adjustable range for Survivor and Killer sides.'],
				list: ['Flank awareness', 'Exit gate approaches', 'Adjustable range'],
			},
			{
				h2: 'With ESP',
