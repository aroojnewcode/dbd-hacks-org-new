...
function HomeSeoInner({ faqs, checkoutUrl }: Props) {
	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/dbd-world-esp/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/dbd-cheats/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/dbd-cheats/', labelKey: 'homeSeo.linkDBDCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
