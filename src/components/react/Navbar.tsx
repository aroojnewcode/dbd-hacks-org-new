...
const icons: Record<string, string> = {
	home: 'M5.5 10.8 12 5.5l6.5 5.3V19a1 1 0 01-1 1h-4v-6H10.5v6H6.5a1 1 0 01-1-1v-8.2z',
	hacks:
		'M12 3.5l7.5 4.2v8.6L12 20.5l-7.5-4.2V7.7L12 3.5zm0 2.2L6.8 8.5v6.9L12 18.3l5.2-2.9V8.5L12 5.7z',
	features:
		'M4.5 7.5h15M4.5 12h15M4.5 16.5h10M8 4.5v15',
					...
					{navLinks.map((item) => (
						...
						>
							<svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
								<path
									d={icons[item.id] ?? icons.features}
									stroke="currentColor"
									strokeWidth="1.6"
									strokeLinecap="round"
