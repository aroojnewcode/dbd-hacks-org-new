...
| Images | `public/images/` + `src/data/dbd.ts` | Own licensed / provided assets only |
...
- IGN or other second killer pressure scraped images
...
4. Replace images; update **`dbd.ts`** (image registry) paths/alts
