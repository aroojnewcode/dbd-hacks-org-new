...
const REPLACEMENTS = [
	...
	['fortnite hacks', 'warzone hacks'],
	['fortnite cheats', 'warzone cheats'],
	['Battle Royale island, Zero Build, and ranked trials', 'Verdansk, Urzikstan, and Rebirth Island'],
	['Battle Royale island, Zero Build and ranked trials', 'Verdansk, Urzikstan and Rebirth Island'],
