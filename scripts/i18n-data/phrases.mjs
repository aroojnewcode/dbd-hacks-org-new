...
const KW = {
	...
	cheats: 'dead by daylight cheats',
	hack: 'dbd cheat',
	esp: 'dbd esp',
...
export const phrases = {
	es: {
		buy: 'Comprar DBD Hacks', undetected: 'indetectables', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'Contacta support@dbdhacks.net para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter DBD Hacks', undetected: 'indétectables', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'Contactez support@dbdhacks.net pour le support ou les demandes légales.',
	},
	de: {
		buy: 'DBD Hacks kaufen', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar DBD Hacks', undetected: 'indetectáveis', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'Contacte support@dbdhacks.net para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista DBD Hacks', undetected: 'indetectable', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'Contatta support@dbdhacks.net per supporto o richieste legali.',
	},
	nl: {
		buy: 'DBD Hacks kopen', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'DBD Hacks satın al', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'Destek ve yasal sorular için support@dbdhacks.net.',
	},
	ar: {
		buy: 'اشترِ DBD Hacks', undetected: 'غير مكتشف', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'DBD Hacksを購入', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'サポート・法務: support@dbdhacks.net',
	},
	ko: {
		buy: 'DBD Hacks 구매', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => '지원 및 법무: support@dbdhacks.net',
	},
	zh: {
		buy: '购买 DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => '支持与法务：support@dbdhacks.net',
	},
	hi: {
		buy: 'DBD Hacks खरीदें', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'सहायता: support@dbdhacks.net',
	},
	id: {
		buy: 'Beli DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net pentru suport și legal.',
	},
	sv: {
		buy: 'Köp DBD Hacks', undetected: 'undetected', maps: 'The Fog, MacMillan Estate, and Autohaven Wreckers',
		...
		legal: () => 'support@dbdhacks.net för support och juridik.',
	},
};
