#!/usr/bin/env node
/**
 * Ports the 8 posts from ../dbd-blog into src/data/blog/posts.generated.ts
...
const file = `/* Auto-generated by scripts/port-from-dbd-blog.mjs — do not edit by hand. */
